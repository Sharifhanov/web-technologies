Сделана регистрация, связь с базой и передача данных в базу и забор из нее.
    ...
    */
    if(isset($_POST["btn_submit_register"]) && !empty($_POST["btn_submit_register"])){
        ...
        if(isset($_POST["captcha"]) && !empty($captcha)){
			...
			$result_query_insert = $mysqli->query("INSERT INTO `users` (first_name, last_name, email, email_status, password) VALUES ('".$first_name."', '".$last_name."', '".$email."', '1', '".$password."')");
